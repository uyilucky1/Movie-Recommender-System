...
movies_df = pd.read_csv('Movie-Recommender-System/resources/data/movies.csv', sep=',')
ratings_df = pd.read_csv('Movie-Recommender-System/resources/data/ratings.csv')
ratings_df.drop(['timestamp'], axis=1, inplace=True)

# We make use of an SVD model trained on a subset of the MovieLens 10k dataset.
model = pickle.load(open('Movie-Recommender-System/resources/models/SVD.pkl', 'rb'))
